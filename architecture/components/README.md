...
The Firehose components work together in symphony to provide blockchain data from configured and instrumented nodes to consumers through the [Firehose](firehose.md) component.
