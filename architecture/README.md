...
- **[Firehose-enabled Node](components/firehose-enabled-node.md)** - Blockchain node with data extraction
- **[Reader](components/reader.md)** - Extracts and processes blocks from nodes
