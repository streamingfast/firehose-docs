...
Note, the `firehose-cosmos` extractor component is labeled `ingestor` however is functionally identical. Learn more about the Firehose [components](../../architecture/components/) and the overall [concepts and architecture](broken-reference).
