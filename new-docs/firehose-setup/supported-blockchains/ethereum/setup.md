...
Using a web browser download the StreamingFast Geth binary. Download the latest Geth binary or the one with the cooresponding Ethereum versioning to match existing node deployments.&#x20;
