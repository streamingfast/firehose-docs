...
To get started with Firehose the first step is to learn about its core concepts. The next step is to find the documentation for the specific blockchain you intend on working with. &#x20;
